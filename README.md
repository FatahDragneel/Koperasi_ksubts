...
- **Simpanan**: simpanan pokok/wajib/saham, penarikan, SHU.
...
2. Jalankan Apache + MySQL, lalu pilih **salah satu**:
   - **Opsi A (disarankan)** — instalasi baru + data contoh: di phpMyAdmin buat
     database `koperasi_bina_tani2`, tab **Import**, pilih `koperasi/database.sql`.
...
Catatan: nama database MySQL (`koperasi_bina_tani2`) hanya nama teknis internal
