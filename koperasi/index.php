  ...
  <div class="container hero-grid">
    ...
    <div class="hero-card">
      ...
      <ul class="list-check">
        ...
        <li><span class="dot">3</span> Simpanan pokok, wajib, dan saham yang dicatat transparan.</li>
  ...
  <div class="container">
    ...
    <div class="cards">
      ...
      <div class="card">
        ...
        <p>Simpanan pokok, wajib, dan saham yang dicatat transparan untuk usaha tani anggota.</p>
      </div>
      <div class="card">
        <div class="icon">✦</div>
